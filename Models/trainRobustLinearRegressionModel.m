function [trainedModel, validationRMSE] = trainRobustLinearRegressionModel(trainingData)
...
% Auto-generated by MATLAB on 26-May-2022 16:19:46
...
concatenatedPredictorsAndResponse.AverageBinPA = response;
linearModel = fitlm(...
...
for fold = 1:KFolds
    ...
    concatenatedPredictorsAndResponse.AverageBinPA = trainingResponse;
    linearModel = fitlm(...
        concatenatedPredictorsAndResponse, ...
        'linear', ...
        'RobustOpts', 'on');
